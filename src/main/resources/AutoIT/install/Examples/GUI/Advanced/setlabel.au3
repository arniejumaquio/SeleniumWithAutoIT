...
;
; Script Function
; Creates a simple GUI showing the use of a label, a combobox and a button
; Selecting an item from the combobox and clicking the button updates the label text
